...
1.  All nodes should at least fulfil the minimal requirements, for UCP 3.0, 8GB of RAM and 3GB of storage. For production systems, 16GB of RAM is recommended for manager nodes. More detailed requirements are in the Docker EE UCP documentation at [https://docs.docker.com/ee/ucp/admin/install/system-requirements/](https://docs.docker.com/ee/ucp/admin/install/system-requirements/).
...
For this solution, the following tables describe sizing configurations, assuming 3 Linux workers and 3 Windows workers. The vCPU allocations are described in [\#vcpu-table-conref](#vcpu-table-conref) while the memory allocation is described in [\#memory-alloc-table-conref](#memory-alloc-table-conref).
